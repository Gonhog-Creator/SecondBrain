...
Source: junk_drawer/github/DeltaDash/frontend/src/pages/Ammunition.tsx.txt

Category: [[github-code]]

## Summary
import { useState } from 'react'; import { useAmmunition, useCreateAmmunition, useUpdateAmmunition, useDeleteAmmunition } from '../hooks/useAmmunition'; import { useAuth } from '../hooks/useAuth'; import { Ammunition, AmmunitionCreate, AmmunitionUpdate } from '../api/ammunition'; import { ConfirmModal } from '../components/ConfirmModal'; export function AmmunitionPage() { const { data: ammunitionList, isLoading, error } = useAmmunition(); const createMutation = useCreateAmmunition(); const updat
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/pages/Ammunition.tsx.txt
