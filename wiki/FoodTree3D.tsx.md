...
Source: junk_drawer/github/PersonalWebsite/src/app/side-quests/foodtree/components/FoodTree3D.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import React, { useRef, useState, useMemo, useEffect, Suspense, useCallback } from 'react'; import { Canvas, useFrame, useThree } from '@react-three/fiber'; import { OrbitControls, Text, Billboard } from '@react-three/drei'; // Removed unused Sphere import import * as THREE from 'three'; import { useFoodTree } from '../hooks/useFoodTree'; type NodeType = 'ingredient' | 'dish' | 'root';
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/side-quests/foodtree/components/FoodTree3D.tsx.txt
