...
Source: junk_drawer/github/PersonalWebsite/src/lib/kv.ts.txt

Category: [[github-code]]

## Summary
import { createClient, RedisClientType } from 'redis'; // Cache TTL in seconds (5 minutes) const CACHE_TTL = 300; // Create a type for our Redis client type RedisClient = ReturnType<typeof createClient>; let redisClient: RedisClient | null = null; let isConnecting = false;
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/lib/kv.ts.txt
