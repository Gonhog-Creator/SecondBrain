...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-06_11.54.54-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Daisy, daisy... Time: 3/6/21 11:54 AM Description: Exception generating new chunk java.lang.IllegalArgumentException: bound must be positive at java.util.Random.nextInt(Random.java:388) ~[?:1.8.0_275] {} at net.minecraft.world.gen.feature.structure.Structure.getChunkPosForStructure(Structure.java:202) ~[forge:?] {re:classloading,pl:accesstransformer:B} at net.minecraft.world.gen.feature.structure.Structure.func_242785_a(Structure.java:221) ~[forge:?] {re:class

## Full Content
---- Minecraft Crash Report ----
// Daisy, daisy...

Time: 3/6/21 11:54 AM
Description: Exception generating new chunk

java.lang.IllegalArgumentException: bound must be positive
	at java.util.Random.nextInt(Random.java:388) ~[?:1.8.0_275] {}
	at net.minecraft.world.gen.feature.structure.Structure.getChunkPosForStructure(Structure.java:202) ~[forge:?] {re:classloading,pl:accesstransformer:B}
...
Details:
	Location: -16,1
	Position hash: 8589934576
	Generator: net.minecraft.world.gen.NoiseChunkGenerator@6b576339
Stacktrace:
	at net.minecraft.world.server.ChunkManager.lambda$null$18(ChunkManager.java:541) ~[forge:?] {re:classloading}
...
Details:
	...
	Level spawn location: World: (-248,64,24), Chunk: (at 8,4,8 in -16,1; contains blocks -256,0,16 to -241,255,31), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
Details:
	...
	Memory: 953576920 bytes (909 MB) / 1949302784 bytes (1859 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 5cb8d567-8b8b-4a58-8d74-b564b0091af8
	Player Count: 0 / 8; []
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-06_11.54.54-server.txt
