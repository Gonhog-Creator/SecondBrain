...
Source: junk_drawer/github/RoADashboard/Parsing Tools/BuildlingsParser/excel_to_yaml.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Excel to YAML Converter Reads the edited Excel file and rebuilds the YAML file with updated costs, durations, and rewards while preserving all other data and formatting. """ import pandas as pd from ruamel.yaml import YAML
...
## Metadata
- Source file: junk_drawer/github/RoADashboard/Parsing Tools/BuildlingsParser/excel_to_yaml.py.txt
