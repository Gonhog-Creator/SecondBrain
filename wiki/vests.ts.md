...
Source: junk_drawer/github/DeltaDash/frontend/src/api/vests.ts.txt

Category: [[github-code]]

## Summary
import { apiClient } from './client'; export interface VestLayer { id: string; vest_id: string; layer_index: number; material_id: string | null; orientation_degrees: number | null; layer_count: number; notes: string | null;
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/api/vests.ts.txt
