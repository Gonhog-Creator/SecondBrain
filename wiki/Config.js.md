...
Source: junk_drawer/github/EvolutionSimSite/src/js/core/Config.js.txt

Category: [[github-code]]

## Summary
/** * Application configuration manager */ class Config { constructor() { this.config = { // Default configuration values debug: false, maxFPS: 60, renderScale: window.devicePixelRatio || 1,
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/core/Config.js.txt
