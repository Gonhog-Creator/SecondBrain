...
Source: junk_drawer/github/EvolutionSimSite/scripts/run-setup-wasm.js.txt

Category: [[github-code]]

## Summary
import { execSync } from 'child_process'; import { fileURLToPath } from 'url'; import { dirname, join } from 'path'; import { chmodSync, existsSync, readdirSync, copyFileSync, mkdirSync } from 'fs'; const __filename = fileURLToPath(import.meta.url); const __dirname = dirname(__filename); const isWindows = process.platform === 'win32'; const scriptName = isWindows ? 'setup_wasm.cmd' : 'setup_wasm.sh';
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/scripts/run-setup-wasm.js.txt
