...
Source: junk_drawer/github/PersonalWebsite/src/components/gallery/PanoramaViewer.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { useState, useEffect, useRef, useCallback } from 'react'; import Image, { ImageProps } from 'next/image'; import { FaTimes } from 'react-icons/fa'; // Removed empty interface in favor of direct type usage export function PanoramaViewer({ ...imageProps }: Omit<ImageProps, 'onClick' | 'className'>) { const [isModalOpen, setIsModalOpen] = useState(false);
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/gallery/PanoramaViewer.tsx.txt
