...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_20.00.59-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // I let you down. Sorry :( Time: 12/20/20 8:00 PM Description: Ticking entity java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSetAttackTargetEvent at net.minecraftforge.eventbus.api.Event.setCanceled(Event.java:95) ~[eventbus-3.0.5-service.jar:?] {} at com.gonhog.theancientworld.events.ClientEventHandler.makePlayerUntargetable(ClientEventHandler.java:40
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_20.00.59-server.txt
