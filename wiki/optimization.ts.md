...
Source: junk_drawer/github/PersonalWebsite/src/app/roasim/optimization.ts.txt

Category: [[github-code]]

## Summary
import { Attackers, EnemyTroops, ResearchState, SpecialItems, TroopStats } from './types'; import { TROOP_STATS } from './troop-data'; import { ENEMY_COMPOSITIONS } from './enemy-compositions'; // Types for optimization export interface OptimizationConfig { attackers: Attackers; defender: { terrain: 'camp' | 'forest' | 'savanna' | 'lake' | 'mountain' | 'hills' | 'plains' | 'enemy'; level: number;
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/roasim/optimization.ts.txt
