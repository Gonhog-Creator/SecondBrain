...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_17.36.53-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // You're mean. Time: 2/9/21 5:36 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:36) ~[main/:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.JumpRing.inventoryTick(JumpRing.java:44) ~[main/:?] {re:classloading}
...
java.lang.NullPointerException: Ticking player
	...
	at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:36) ~[main/:?] {re:classloading}
	at com.gonhog.theancientworld.items.potionRings.JumpRing.inventoryTick(JumpRing.java:44) ~[main/:?] {re:classloading}
	...
	at net.minecraftforge.eventbus.ASMEventHandler_26_CuriosEventHandler_tick_LivingUpdateEvent.invoke(.dynamic) ~[?:?] {}
...
Details:
	...
	Entity ID: 101
	Entity Name: Dev
	Entity's Exact location: -109.00, 4.00, 107.14
...
Details:
	...
	Memory: 1217431744 bytes (1161 MB) / 1851260928 bytes (1765 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: e626b97a-eadf-4000-b458-572df7c3043a
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/101, l='ServerLevel[Dev]', x=-109.00, y=4.00, z=107.14]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_17.36.53-server.txt
