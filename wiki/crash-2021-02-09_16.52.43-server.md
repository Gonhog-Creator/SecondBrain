...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_16.52.43-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Would you like a cupcake? Time: 2/9/21 4:52 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.isPotionActive(PotionRingEffectHandler.java:42) ~[main/:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:52) ~[main/:?] {re:classloading}
...
java.lang.NullPointerException: Ticking player
	...
	at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.isPotionActive(PotionRingEffectHandler.java:42) ~[main/:?] {re:classloading}
	at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:52) ~[main/:?] {re:classloading}
	...
	at top.theillusivec4.curios.common.event.CuriosEventHandler.lambda$tick$23(CuriosEventHandler.java:396) ~[curios-forge-1.16.4-4.0.3.4_mapped_snapshot_20201028-1.16.3.jar:property(class java.lang.String, map(provider(?)))] {re:classloading}
	at net.minecraftforge.common.util.LazyOptional.ifPresent(LazyOptional.java:161) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading}
	at top.theillusivec4.curios.common.event.CuriosEventHandler.tick(CuriosEventHandler.java:378) ~[curios-forge-1.16.4-4.0.3.4_mapped_snapshot_20201028-1.16.3.jar:property(class java.lang.String, map(provider(?)))] {re:classloading}
	at net.minecraftforge.eventbus.ASMEventHandler_24_CuriosEventHandler_tick_LivingUpdateEvent.invoke(.dynamic) ~[?:?] {}
	...
	at net.minecraftforge.common.ForgeHooks.onLivingUpdate(ForgeHooks.java:314) ~[forge:?] {re:classloading}
	at net.minecraft.entity.LivingEntity.tick(LivingEntity.java:2259) ~[forge:?] {re:classloading}
...
Details:
	...
	Entity ID: 108
	Entity Name: Dev
	Entity's Exact location: -108.25, 5.00, 109.16
	Entity's Block location: World: (-109,5,109), Chunk: (at 3,0,13 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
Details:
	...
	Memory: 556402240 bytes (530 MB) / 1868562432 bytes (1782 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: d3f009ee-0c3b-4afc-934e-459e77c7092e
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/108, l='ServerLevel[Dev]', x=-108.25, y=5.00, z=109.16]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_16.52.43-server.txt
