...
Source: junk_drawer/github/DeltaDash/backend/app/api/v1/materials.py.txt

Category: [[github-code]]

## Summary
from typing import List, Optional from fastapi import APIRouter, Depends, HTTPException, status, UploadFile, File, Form from fastapi.responses import FileResponse from sqlalchemy.orm import Session import os import uuid from pathlib import Path from app.db.session import get_db from app.db.models import Material as MaterialModel
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/app/api/v1/materials.py.txt
