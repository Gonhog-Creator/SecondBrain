...
Source: junk_drawer/github/EvolutionSimSite/src/public/diagnostics.html.txt

Category: [[github-code]]

## Summary
<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>Evolution Simulator - Diagnostics Console</title> <style> :root { --primary: #4a6fa5; --success: #4caf50;
        ...
        <div id="performance-tab" class="tab-content">
            ...
            <div class="controls">
                <button id="start-profiling">
                    <span>⏯️</span> Start Profiling
                </button>
                <button id="stop-profiling" disabled>
                    <span>⏹️</span> Stop Profiling
                </button>
        ...
        <div id="wasm-tab" class="tab-content">
            ...
            <div class="controls">
                <button id="reload-wasm">
                    <span>🔄</span> Reload Module
                </button>
                <button id="wasm-benchmark" class="secondary">
                    <span>⚡</span> Run Benchmark
                </button>
        ...
        const app = (() => {
                    ...
                    elements.copyConsole.addEventListener('click', () => {
                        try {
                            ...
                            navigator.clipboard.writeText(consoleText).then(() => {
                                ...
                                elements.copyConsole.innerHTML = '<span>✓</span> Copied!';
                    ...
                    elements.exportLogs.addEventListener('click', (e) => {
                        ...
                        try {
                            ...
                            if (elements.exportLogs) {
                                ...
                                elements.exportLogs.innerHTML = '<span>❌</span> Failed!';
                    ...
                    try {
                        if (elements.consoleOutput) {
                            ...
                            if (elements.clearConsole) {
                                ...
                                elements.clearConsole.innerHTML = '<span>✓</span> Cleared!';
            ...
            function exportLogs() {
                try {
                    ...
                    if (elements.exportLogs) {
                        const originalText = elements.exportLogs.innerHTML;
                        elements.exportLogs.innerHTML = '<span>✓</span> Exported!';
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/public/diagnostics.html.txt
