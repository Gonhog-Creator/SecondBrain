...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.31.12-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Why is it breaking :( Time: 1/27/21 10:31 PM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java:164) ~[forge-1.16.5-geckol

## Full Content
---- Minecraft Crash Report ----
// Why is it breaking :(

Time: 1/27/21 10:31 PM
...
Details:
	...
	Entity's Exact location: -73.55, 4.00, 85.63
	Entity's Block location: World: (-74,4,85), Chunk: (at 6,0,5 in -5,5; contains blocks -80,0,80 to -65,255,95), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.centaur.CentaurRender@323eecf8
	Location: 36.54,-1.39,-16.74 - World: (36,-2,-17), Chunk: (at 4,-1,15 in 2,-2; contains blocks 32,0,-32 to 47,255,-17), Region: (0,-1; contains chunks 0,-32 to 31,-1, blocks 0,0,-512 to 511,255,-1)
	Rotation: -60.46875
	Delta: 0.0
Stacktrace:
...
Details:
	...
	Level time: 12068 game time, 12068 day time
	Server brand: forge
...
Details:
	...
	Memory: 828300528 bytes (789 MB) / 1891106816 bytes (1803 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 6db8da68-fa08-4a18-bd15-257ed9457ebc
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.31.12-client.txt
