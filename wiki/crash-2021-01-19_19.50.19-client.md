...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-19_19.50.19-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // I feel sad now :( Time: 1/19/21 7:50 PM Description: Unexpected error java.lang.NullPointerException: Unexpected error at net.minecraft.client.multiplayer.PlayerController.processRightClick(PlayerController.java:347) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:runtimedistcleaner:A} at net.minecraft.client.Minecraft.rightClickMouse(Minecraft.java:1430) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?

## Full Content
---- Minecraft Crash Report ----
// I feel sad now :(

Time: 1/19/21 7:50 PM
Description: Unexpected error

java.lang.NullPointerException: Unexpected error
	at net.minecraft.client.multiplayer.PlayerController.processRightClick(PlayerController.java:347) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:runtimedistcleaner:A}
	at net.minecraft.client.Minecraft.rightClickMouse(Minecraft.java:1430) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:accesstransformer:B,pl:runtimedistcleaner:A}
...
Stacktrace:
	at net.minecraft.client.multiplayer.PlayerController.processRightClick(PlayerController.java:347) ~[forge:?] {re:classloading,pl:runtimedistcleaner:A}
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/165, l='ClientLevel', x=-219.05, y=84.00, z=-242.64]]
	...
	Level time: 138938 game time, 10811 day time
	Server brand: forge
...
Details:
	...
	Memory: 1065006088 bytes (1015 MB) / 1888485376 bytes (1801 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: b2d5e4db-c378-4b72-995a-b2ee78aa77e1
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-19_19.50.19-client.txt
