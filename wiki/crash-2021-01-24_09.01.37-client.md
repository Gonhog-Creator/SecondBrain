...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-24_09.01.37-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // My bad. Time: 1/24/21 9:01 AM Description: Unexpected error java.lang.ClassCastException: net.minecraft.client.world.ClientWorld cannot be cast to net.minecraft.world.server.ServerWorld at com.gonhog.theancientworld.items.spawnereggs.UnicornEgg.onItemUse(UnicornEgg.java:35) ~[main/:?] {re:classloading} at net.minecraft.item.ItemStack.lambda$onItemUse$5(ItemStack.java:192) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at 

## Full Content
---- Minecraft Crash Report ----
// My bad.

Time: 1/24/21 9:01 AM
...
java.lang.ClassCastException: net.minecraft.client.world.ClientWorld cannot be cast to net.minecraft.world.server.ServerWorld
	at com.gonhog.theancientworld.items.spawnereggs.UnicornEgg.onItemUse(UnicornEgg.java:35) ~[main/:?] {re:classloading}
...
Stacktrace:
	at com.gonhog.theancientworld.items.spawnereggs.UnicornEgg.onItemUse(UnicornEgg.java:35) ~[?:?] {re:classloading}
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/176, l='ClientLevel', x=-210.31, y=80.00, z=-272.99]]
	Chunk stats: Client Chunk Cache: 841, 553
	...
	Level time: 156433 game time, 5236 day time
	Server brand: forge
...
Details:
	...
	Memory: 697794288 bytes (665 MB) / 1896873984 bytes (1809 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: ca07edf9-d653-442c-876d-2eb7303b68e2
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-24_09.01.37-client.txt
