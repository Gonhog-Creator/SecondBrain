...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_18.30.20-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // I blame Dinnerbone. Time: 2/9/21 6:30 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:36) ~[main/:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.JumpRing.inventoryTick(JumpRing.java:45) ~[main/:?] {re:classloading}
...
java.lang.NullPointerException: Ticking player
	...
	at com.gonhog.theancientworld.items.potionRings.JumpRing.inventoryTick(JumpRing.java:45) ~[main/:?] {re:classloading}
...
Details:
	...
	Memory: 1242038912 bytes (1184 MB) / 1884291072 bytes (1797 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: b696e85a-19d4-4d76-9560-bb7bdac7567f
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/120, l='ServerLevel[Dev]', x=-107.57, y=4.00, z=103.99]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_18.30.20-server.txt
