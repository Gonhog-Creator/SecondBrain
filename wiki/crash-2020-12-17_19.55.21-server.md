...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-17_19.55.21-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Quite honestly, I wouldn't worry myself about that. Time: 12/17/20 7:55 PM Description: Ticking player java.lang.ArrayIndexOutOfBoundsException: 4 at java.util.Arrays$ArrayList.get(Arrays.java:3841) ~[?:1.8.0_275] {} at net.minecraft.util.NonNullList.get(NonNullList.java:45) ~[forge:?] {re:classloading} at net.minecraft.entity.player.PlayerInventory.armorItemInSlot(PlayerInventory.java:555) ~[forge:?] {re:classloading}
...
Details:
	...
	Memory: 1438489632 bytes (1371 MB) / 1857552384 bytes (1771 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: cfa4fe93-7d9e-4364-89b3-2743736c2c48
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/171, l='ServerLevel[New World]', x=-202.74, y=78.00, z=-250.77]]
	Data Packs: vanilla, mod:theancientworld, mod:forge
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-17_19.55.21-server.txt
