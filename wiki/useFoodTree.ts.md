...
Source: junk_drawer/github/PersonalWebsite/src/app/side-quests/foodtree/hooks/useFoodTree.ts.txt

Category: [[github-code]]

## Summary
'use client'; import { useState, useEffect, useCallback, useRef, useMemo } from 'react'; export type NodeType = 'ingredient' | 'dish' | 'root' | 'plant' | 'animal' | 'other'; export interface FoodNode { id: string; name: string; type: NodeType;
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/side-quests/foodtree/hooks/useFoodTree.ts.txt
