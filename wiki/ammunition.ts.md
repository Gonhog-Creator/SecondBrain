...
Source: junk_drawer/github/DeltaDash/frontend/src/api/ammunition.ts.txt

Category: [[github-code]]

## Summary
import { apiClient } from './client'; export interface Ammunition { id: string; name: string; caliber: string | null; caliber_unit: string | null; caliber_diameter_mm: number | null; caliber_length_mm: number | null; caliber_inch: number | null;
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/api/ammunition.ts.txt
