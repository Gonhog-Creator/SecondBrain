...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_22.47.45-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Hey, that tickles! Hehehe! Time: 2/12/21 10:47 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_snapshot_2020102

## Full Content
---- Minecraft Crash Report ----
// Hey, that tickles! Hehehe!

Time: 2/12/21 10:47 PM
...
Details:
	...
	Failure message: The Ancient World (theancientworld) encountered an error during the load_registries event phase
		java.lang.NullPointerException: Registry Object not present: theancientworld:unicorn
	Mod Version: 1.16.4 -1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.NullPointerException: Registry Object not present: theancientworld:unicorn
Stacktrace:
	at java.util.Objects.requireNonNull(Objects.java:290) ~[?:1.8.0_275] {}
	...
	at com.gonhog.theancientworld.util.RegistryHandler.lambda$static$34(RegistryHandler.java:147) ~[main/:?] {re:classloading}
...
Details:
	...
	Memory: 1369531952 bytes (1306 MB) / 1721237504 bytes (1641 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Mod List: 
		...
		main                                              |The Ancient World             |theancientworld               |1.16.4 -1.0         |VALIDATE  |NOSIGNATURE
		forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.|Forge                         |forge                         |35.1.4              |COMMON_SET|NOSIGNATURE
		curios-forge-1.16.4-4.0.3.4_mapped_snapshot_202010|Curios API                    |curios                        |1.16.4-4.0.3.4      |COMMON_SET|NOSIGNATURE
		forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201|GeckoLib                      |geckolib3                     |3.0.4a              |COMMON_SET|NOSIGNATURE
	Crash Report UUID: 2a3931b5-9204-4457-baa1-d48ff921e886

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_22.47.45-fml.txt
