...
Source: junk_drawer/github/BudgetTool/backend/app/services/transfer_detection.py.txt

Category: [[github-code]]

## Summary
from sqlalchemy.orm import Session from app.models import Transaction as TransactionModel, Account from datetime import timedelta from typing import List, Tuple class TransferDetectionService: """Service for detecting transfers between accounts""" def detect_transfers(self, db: Session, user_id: int): """
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/app/services/transfer_detection.py.txt
