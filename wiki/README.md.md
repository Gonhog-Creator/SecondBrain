...
Source: junk_drawer/github/DeltaVision/README.md.txt

Category: [[github-code]]

## Summary
# DeltaVision - Factory Analytics for Bulletproof Vest Manufacturing DeltaVision is a production-ready computer vision system designed to analyze CCTV footage from bulletproof vest manufacturing facilities. It provides real-time analytics, productivity metrics, bottleneck detection, and comprehensive reporting for optimizing factory operations. ## Key Features - **Real-time Person Detection & Tracking**: Uses YOLOv8 and ByteTrack for anonymous worker tracking - **Zone-based Analytics**: Define w
...
## Metadata
- Source file: junk_drawer/github/DeltaVision/README.md.txt
