...
Source: junk_drawer/github/EvolutionSimSite/src/js/managers/SaveManager.js.txt

Category: [[github-code]]

## Summary
import { logger } from '../utils/logger.js'; import { eventBus } from '../core/EventBus.js'; import { config } from '../core/Config.js'; // Constants const SAVE_VERSION = '2.0.0'; const SAVE_PREFIX = 'evosim_save_'; const AUTOSAVE_KEY = 'evosim_autosave'; const SAVE_SLOTS = 10; const AUTOSAVE_INTERVAL = 5 * 60 * 1000; // 5 minutes
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/managers/SaveManager.js.txt
