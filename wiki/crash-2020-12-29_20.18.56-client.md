...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-29_20.18.56-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't do that. Time: 12/29/20 8:18 PM Description: Ticking block entity java.lang.NullPointerException: Ticking block entity at net.minecraft.world.World.tickBlockEntities(World.java:537) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:accesstransformer:B} at net.minecraft.client.world.ClientWorld.tickEntities(ClientWorld.java:181) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:ru

## Full Content
---- Minecraft Crash Report ----
// Don't do that.

Time: 12/29/20 8:18 PM
Description: Ticking block entity

java.lang.NullPointerException: Ticking block entity
	at net.minecraft.world.World.tickBlockEntities(World.java:537) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:accesstransformer:B}
	at net.minecraft.client.world.ClientWorld.tickEntities(ClientWorld.java:181) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:runtimedistcleaner:A}
...
Details:
	...
	Block: Block{theancientworld:test_block}[facing=south]
...
Stacktrace:
	at net.minecraft.world.World.tickBlockEntities(World.java:537) ~[forge:?] {re:classloading,pl:accesstransformer:B}
	at net.minecraft.client.world.ClientWorld.tickEntities(ClientWorld.java:181) ~[forge:?] {re:classloading,pl:runtimedistcleaner:A}


-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/183, l='ClientLevel', x=-201.52, y=78.00, z=-250.56]]
	...
	Level time: 56304 game time, 8127 day time
	Server brand: forge
...
Details:
	...
	Memory: 859385912 bytes (819 MB) / 1889009664 bytes (1801 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: a472766c-a9f0-4ae7-9f69-b0b26288a9ed
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-29_20.18.56-client.txt
