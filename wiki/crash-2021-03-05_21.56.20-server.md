...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-05_21.56.20-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Hey, that tickles! Hehehe! Time: 3/5/21 9:56 PM Description: Exception generating new chunk java.lang.ArithmeticException: / by zero at java.lang.Math.floorDiv(Math.java:1052) ~[?:1.8.0_275] {} at net.minecraft.world.gen.feature.structure.Structure.getChunkPosForStructure(Structure.java:196) ~[forge:?] {re:classloading,pl:accesstransformer:B} at net.minecraft.world.gen.feature.structure.Structure.func_242785_a(Structure.java:221) ~[forge:?] {re:classloading,pl
...
Details:
	Location: 0,0
	Position hash: 0
	Generator: net.minecraft.world.gen.NoiseChunkGenerator@5edc1603
Stacktrace:
	at net.minecraft.world.server.ChunkManager.lambda$null$18(ChunkManager.java:541) ~[forge:?] {re:classloading}
...
Details:
	...
	Memory: 895370344 bytes (853 MB) / 1887436800 bytes (1800 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 38ded7b7-579b-4e58-b1c0-f9b7016a3788
	Player Count: 0 / 8; []
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-05_21.56.20-server.txt
