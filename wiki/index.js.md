...
Source: junk_drawer/github/EvolutionSimSite/src/assets/wasm/index.js.txt

Category: [[github-code]]

## Summary
// WebAssembly module loader export default function(Module = {}) { return new Promise((resolve, reject) => { // Add the Module configuration window.Module = { ...Module, locateFile: (path) => { if (path.endsWith('.wasm')) { return '/wasm/index.wasm'; }
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/assets/wasm/index.js.txt
