...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_19.09.05-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Oh - I know what I did wrong! Time: 2/9/21 7:09 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:38) ~[?:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.JumpRing.inventoryTick(JumpRing.java:42) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 1118521168 bytes (1066 MB) / 1849688064 bytes (1764 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: aef59038-e2bc-4638-aa2a-0807833b2aeb
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/102, l='ServerLevel[Dev]', x=-107.57, y=4.00, z=103.99]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_19.09.05-server.txt
