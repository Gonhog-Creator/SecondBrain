...
Source: junk_drawer/github/EvolutionSimSite/src/engine/wasm_bindings.cpp.txt

Category: [[github-code]]

## Summary
#include <emscripten/bind.h> #include <emscripten/val.h> #include "TemperatureSystem.hpp" #include "serialization/SaveSystem.hpp" using namespace emscripten; // Wrapper class to expose TemperatureSystem to JavaScript class TemperatureSystemWrapper { public:
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/engine/wasm_bindings.cpp.txt
