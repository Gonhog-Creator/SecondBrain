...
Source: junk_drawer/github/DeltaDash/backend/scripts/seed_users.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Seed users script. Creates an admin user and a test user for testing permissions. """ import sys import os sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/scripts/seed_users.py.txt
