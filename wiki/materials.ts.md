...
Source: junk_drawer/github/DeltaDash/frontend/src/api/materials.ts.txt

Category: [[github-code]]

## Summary
import { apiClient } from './client'; export interface Material { id: string; name: string; normalized_name: string | null; manufacturer: string | null; supplier: string | null; material_class: string | null; fiber_type: string | null;
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/api/materials.ts.txt
