...
Source: junk_drawer/github/EvolutionSimSite/src/scripts/build_wasm.sh.txt

Category: [[github-code]]

## Summary
#!/bin/bash # Exit on error set -e # Source Emscripten environment SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)" PROJECT_DIR="$SCRIPT_DIR/.." # Check for GitHub Actions environment first
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/scripts/build_wasm.sh.txt
