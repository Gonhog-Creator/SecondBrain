...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_14.45.32-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Oh - I know what I did wrong! Time: 2/9/21 2:45 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:42) ~[?:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:65) ~[?:?] {re:classloading}
...
java.lang.NullPointerException: Ticking player
	...
	at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:65) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 762863840 bytes (727 MB) / 1971322880 bytes (1880 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 9a01e147-1ef1-4f64-8d41-d96dd64563f0
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/111, l='ServerLevel[Dev]', x=-108.44, y=5.00, z=108.93]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_14.45.32-server.txt
