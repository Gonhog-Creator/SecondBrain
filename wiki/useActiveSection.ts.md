...
Source: junk_drawer/github/PersonalWebsite/src/hooks/useActiveSection.ts.txt

Category: [[github-code]]

## Summary
'use client'; import { useState, useEffect, useRef, useCallback, useMemo } from 'react'; import { usePathname } from 'next/navigation'; interface UseActiveSectionOptions { rootMargin?: string; threshold?: number | number[]; offset?: number; }
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/hooks/useActiveSection.ts.txt
