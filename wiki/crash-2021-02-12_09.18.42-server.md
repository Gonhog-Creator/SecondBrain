...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_09.18.42-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Hey, that tickles! Hehehe! Time: 2/12/21 9:18 AM Description: Ticking entity java.lang.NullPointerException: Ticking entity at com.gonhog.theancientworld.entities.TAWGolem.travel(TAWGolem.java:165) ~[?:?] {re:classloading} at net.minecraft.entity.LivingEntity.livingTick(LivingEntity.java:2600) ~[forge:?] {re:classloading} at net.minecraft.entity.MobEntity.livingTick(MobEntity.java:538) ~[forge:?] {re:classloading,pl:accesstransformer:B}

## Full Content
---- Minecraft Crash Report ----
// Hey, that tickles! Hehehe!

Time: 2/12/21 9:18 AM
...
Details:
	...
	Entity's Exact location: -105.56, 4.00, 107.11
	Entity's Block location: World: (-106,4,107), Chunk: (at 6,0,11 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
	Entity's Momentum: 0.00, -0.08, 0.00
	Entity's Passengers: [ServerPlayerEntity['Dev'/97, l='ServerLevel[Dev]', x=-105.56, y=5.95, z=107.11]]
...
-- Affected level --
Details:
	All players: 1 total; [ServerPlayerEntity['Dev'/97, l='ServerLevel[Dev]', x=-105.56, y=5.95, z=107.11]]
	Chunk stats: ServerChunkCache: 2079
	...
	Level time: 213372 game time, 1444 day time
	Level name: Dev
...
Details:
	...
	Memory: 992637520 bytes (946 MB) / 1935671296 bytes (1846 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: b3184bca-2f65-4a55-b948-54d072452d4d
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/97, l='ServerLevel[Dev]', x=-105.56, y=5.95, z=107.11]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_09.18.42-server.txt
