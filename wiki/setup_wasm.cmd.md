...
Source: junk_drawer/github/EvolutionSimSite/src/scripts/setup_wasm.cmd.txt

Category: [[github-code]]

## Summary
@echo off echo Setting up WebAssembly files... :: Set source and destination directories set SRC_DIR=..\..\build_wasm set DEST_DIR=..\..\src\public\wasm :: Create destination directory if it doesn't exist if not exist "%DEST_DIR%" mkdir "%DEST_DIR%"
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/scripts/setup_wasm.cmd.txt
