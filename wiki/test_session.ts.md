...
Source: junk_drawer/github/DeltaDash/frontend/src/api/test_session.ts.txt

Category: [[github-code]]

## Summary
import { apiClient } from './client'; export interface TestSession { id: string; name: string; test_date: string | null; lab_name: string | null; operator: string | null; protocol: string | null; clay_temperature_c: number | null;
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/api/test_session.ts.txt
