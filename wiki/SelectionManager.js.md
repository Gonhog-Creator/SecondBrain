...
Source: junk_drawer/github/EvolutionSimSite/src/js/managers/SelectionManager.js.txt

Category: [[github-code]]

## Summary
import { logger } from '../utils/logger.js'; export class SelectionManager { constructor() { this.selectedCell = null; this.hoveredCell = null; this.isDragging = false; this.lastProcessedCell = null; // Track last processed cell during drag this.tooltip = this.createTooltip(); this.cellSize = 20; // Default, will be updated
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/managers/SelectionManager.js.txt
