...
Source: junk_drawer/github/DeltaDash/backend/app/db/models/prediction.py.txt

Category: [[github-code]]

## Summary
from sqlalchemy import Column, String, Numeric, Boolean, Integer, DateTime, ForeignKey, func from sqlalchemy.dialects.postgresql import UUID, JSONB import uuid from app.db.base import Base class Prediction(Base): __tablename__ = "predictions"
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/app/db/models/prediction.py.txt
