...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-21_11.14.55-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Ouch. That hurt :( Time: 12/21/20 11:14 AM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.

## Full Content
---- Minecraft Crash Report ----
// Ouch. That hurt :(

Time: 12/21/20 11:14 AM
...
Details:
	...
	Failure message: The Ancient World (theancientworld) has failed to load correctly
		java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.event.TickEvent$WorldTickEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
	Mod Version: 1.16.4 -1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.event.TickEvent$WorldTickEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
Stacktrace:
	at net.minecraftforge.eventbus.EventBus.addListener(EventBus.java:236) ~[eventbus-3.0.5-service.jar:?] {}
...
Details:
	...
	Memory: 480210792 bytes (457 MB) / 1720713216 bytes (1641 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 7bb5e9a7-a01c-4045-843f-9d1d2d3bc30e

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-21_11.14.55-fml.txt
