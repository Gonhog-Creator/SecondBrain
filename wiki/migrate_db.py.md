...
Source: junk_drawer/github/BudgetTool/backend/migrate_db.py.txt

Category: [[github-code]]

## Summary
""" Migration script to add accounts table and account_id column to transactions table """ import sqlite3 import os def migrate(): db_path = os.path.join(os.path.dirname(__file__), 'budget.db') if not os.path.exists(db_path):
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/migrate_db.py.txt
