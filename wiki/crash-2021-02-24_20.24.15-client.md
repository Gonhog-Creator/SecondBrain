...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-24_20.24.15-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Surprise! Haha. Well, this is awkward. Time: 2/24/21 8:24 PM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:101) ~[forge-1.16.5-geckolib-3.0.6_mapped_snapshot_20201028-1.16.3.jar:3.0.6] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java:165) ~[forg

## Full Content
---- Minecraft Crash Report ----
// Surprise! Haha. Well, this is awkward.

Time: 2/24/21 8:24 PM
...
Details:
	...
	Entity's Exact location: -186.80, 70.00, -250.84
	Entity's Block location: World: (-187,70,-251), Chunk: (at 5,4,5 in -12,-16; contains blocks -192,0,-256 to -177,255,-241), Region: (-1,-1; contains chunks -32,-32 to -1,-1, blocks -512,0,-512 to -1,255,-1)
	Entity's Momentum: 0.09, -0.08, 0.10
	Entity's Passengers: []
	Entity's Vehicle: ~~ERROR~~ NullPointerException: null

-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.deer.DeerRender@775fec4
	Location: -2.39,-1.62,1.90 - World: (-3,-2,1), Chunk: (at 13,-1,1 in -1,0; contains blocks -16,0,0 to -1,255,15), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
	Rotation: -29.343613
	Delta: 0.25997066
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/152, l='ClientLevel', x=-184.44, y=70.00, z=-252.80]]
	...
	Level time: 15527 game time, 2383 day time
	Server brand: forge
...
Details:
	...
	Memory: 756311280 bytes (721 MB) / 1853358080 bytes (1767 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 8400bb18-fbc3-4315-8769-3f6e39df9a4d
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-24_20.24.15-client.txt
