...
Source: junk_drawer/github/BudgetTool/frontend/src/api/transactions.ts.txt

Category: [[github-code]]

## Summary
import api from './client' import { Transaction } from '../types' export const transactionsApi = { getAll: async (userId: number, params?: any) => { const response = await api.get<Transaction[]>('/transactions', { params: { user_id: userId, ...params } }) return response.data },
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/frontend/src/api/transactions.ts.txt
