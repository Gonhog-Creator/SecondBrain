...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-16_17.46.18-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // You should try our sister game, Minceraft! Time: 1/16/21 5:46 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_s

## Full Content
---- Minecraft Crash Report ----
// You should try our sister game, Minceraft!

Time: 1/16/21 5:46 PM
...
Stacktrace:
	at net.minecraftforge.eventbus.EventBus.checkNotGeneric(EventBus.java:167) ~[eventbus-3.0.5-service.jar:?] {}
-- MOD theancientworld --
Details:
	Mod File: main
...
Stacktrace:
	...
	at net.minecraftforge.eventbus.EventBus.addListener(EventBus.java:173) ~[eventbus-3.0.5-service.jar:?] {}
	at com.gonhog.theancientworld.TheAncientWorld.<init>(TheAncientWorld.java:36) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 1332819960 bytes (1271 MB) / 1708654592 bytes (1629 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 7851d594-e472-4ae4-9f58-04ea35e7c7a5

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-16_17.46.18-fml.txt
