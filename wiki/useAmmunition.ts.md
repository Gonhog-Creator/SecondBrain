...
Source: junk_drawer/github/DeltaDash/frontend/src/hooks/useAmmunition.ts.txt

Category: [[github-code]]

## Summary
import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query'; import { ammunitionApi, AmmunitionCreate, AmmunitionUpdate } from '../api/ammunition'; export function useAmmunition(params?: { skip?: number; limit?: number; caliber?: string }) { return useQuery({ queryKey: ['ammunition', params], queryFn: () => ammunitionApi.list(params), }); }
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/hooks/useAmmunition.ts.txt
