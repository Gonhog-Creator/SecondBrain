...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_14.19.37-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Quite honestly, I wouldn't worry myself about that. Time: 2/9/21 2:19 PM Description: Ticking entity java.lang.NullPointerException: Ticking entity at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:42) ~[main/:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:62) ~[main
...
java.lang.NullPointerException: Ticking entity
	...
	at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:62) ~[main/:?] {re:classloading}
...
Stacktrace:
	...
	at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:62) ~[?:?] {re:classloading}
...
Details:
	...
	Entity ID: 114
	Entity Name: Dev
	Entity's Exact location: -108.59, 5.00, 109.89
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/114, l='ClientLevel', x=-108.59, y=5.00, z=109.89]]
	...
	Level time: 131739 game time, 5944 day time
	Server brand: forge
...
Details:
	...
	Memory: 778044696 bytes (742 MB) / 1891631104 bytes (1804 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 246c869d-d5b6-4280-a467-7f15672eba73
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_14.19.37-client.txt
