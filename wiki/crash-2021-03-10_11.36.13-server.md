...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.36.13-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // On the bright side, I bought you a teddy bear! Time: 3/10/21 11:36 AM Description: Exception ticking world java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSpawnEvent.AllowDespawn at net.minecraftforge.eventbus.api.Event.setCanceled(Event.java:95) ~[eventbus-4.0.0.jar:?] {} at com.gonhog.theancientworld.util.StructureHelpers.canCustomMobSpawn(Structure

## Full Content
---- Minecraft Crash Report ----
// On the bright side, I bought you a teddy bear!

Time: 3/10/21 11:36 AM
Description: Exception ticking world

java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSpawnEvent.AllowDespawn
	...
	at net.minecraftforge.event.ForgeEventFactory.canEntityDespawn(ForgeEventFactory.java:217) ~[forge:?] {re:classloading}
	at net.minecraft.entity.MobEntity.checkDespawn(MobEntity.java:700) ~[forge:?] {re:classloading,pl:accesstransformer:B}
	at net.minecraft.world.server.ServerWorld.tick(ServerWorld.java:391) ~[forge:?] {re:classloading}
...
Details:
	...
	Level weather: Rain time: 155082 (now: false), thunder time: 100173 (now: false)
...
Details:
	...
	Memory: 955829728 bytes (911 MB) / 1843396608 bytes (1758 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 81ade9d2-1000-4d01-a987-68928b2f807c
	Player Count: 0 / 8; []
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.36.13-server.txt
