...
Source: junk_drawer/github/EvolutionSimSite/src/engine/serialization/Serialization.cpp.txt

Category: [[github-code]]

## Summary
#include "Serialization.hpp" #include <cstring> #include <stdexcept> namespace EvolutionSim { // BinaryWriter implementation BinaryWriter::BinaryWriter() { // Reserve some initial space m_data.reserve(1024 * 1024); // 1MB initial capacity
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/engine/serialization/Serialization.cpp.txt
