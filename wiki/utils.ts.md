...
Source: junk_drawer/github/PersonalWebsite/src/lib/utils.ts.txt

Category: [[github-code]]

## Summary
import { clsx, type ClassValue } from 'clsx'; import { twMerge } from 'tailwind-merge'; /** * Combines multiple class names using clsx and tailwind-merge * @param inputs - Class names to be combined * @returns Merged class names */ export function cn(...inputs: ClassValue[]) { return twMerge(clsx(inputs));
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/lib/utils.ts.txt
