...
Source: junk_drawer/github/EvolutionSimSite/src/scripts/setup_wasm.sh.txt

Category: [[github-code]]

## Summary
#!/bin/bash # Exit on error set -e # Get the directory of this script SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)" # Source directory (where the built files are) SRC_DIR="$SCRIPT_DIR/../../build_wasm"
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/scripts/setup_wasm.sh.txt
