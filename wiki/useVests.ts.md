...
Source: junk_drawer/github/DeltaDash/frontend/src/hooks/useVests.ts.txt

Category: [[github-code]]

## Summary
import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query'; import { vestsApi, VestCreate, VestUpdate, VestLayerCreate } from '../api/vests'; export function useVests(params?: { skip?: number; limit?: number; vest_type?: string; threat_level?: string }) { return useQuery({ queryKey: ['vests', params], queryFn: () => vestsApi.list(params), }); }
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/hooks/useVests.ts.txt
