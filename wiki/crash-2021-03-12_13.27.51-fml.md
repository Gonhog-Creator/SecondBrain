...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-12_13.27.51-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // There are four lights! Time: 3/12/21 1:27 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.5-36.0.22_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.5-36.0.22_mapped_snapshot_20201028-1

## Full Content
---- Minecraft Crash Report ----
// There are four lights!

Time: 3/12/21 1:27 PM
...
Details:
	...
	Failure message: The Ancient World (theancientworld) has failed to load correctly
		java.lang.NullPointerException: Registry Object not present: theancientworld:satyr
	Mod Version: 1.16.5 - 1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.NullPointerException: Registry Object not present: theancientworld:satyr
Stacktrace:
	at java.util.Objects.requireNonNull(Objects.java:290) ~[?:1.8.0_275] {}
	at net.minecraftforge.fml.RegistryObject.get(RegistryObject.java:120) ~[forge:?] {re:classloading}
	at com.gonhog.theancientworld.TheAncientWorld.<init>(TheAncientWorld.java:96) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 956736136 bytes (912 MB) / 1732247552 bytes (1652 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: ef7e309c-eae2-40bb-aff9-cc273093358d

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-12_13.27.51-fml.txt
