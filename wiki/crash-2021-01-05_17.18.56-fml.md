...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-05_17.18.56-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Quite honestly, I wouldn't worry myself about that. Time: 1/5/21 5:18 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_
...
Details:
	...
	Failure message: The Ancient World (theancientworld) has failed to load correctly
		java.lang.NullPointerException: Registry Object not present: theancientworld:test_block
	Mod Version: 1.16.4 -1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.NullPointerException: Registry Object not present: theancientworld:test_block
Stacktrace:
	at java.util.Objects.requireNonNull(Objects.java:290) ~[?:1.8.0_275] {}
	at net.minecraftforge.fml.RegistryObject.get(RegistryObject.java:120) ~[forge:?] {re:classloading}
	at com.gonhog.theancientworld.util.RegistryHandler.init(RegistryHandler.java:44) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 1042695664 bytes (994 MB) / 1751646208 bytes (1670 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 3946166d-78e9-4a88-bee9-991e39f3b04c

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-05_17.18.56-fml.txt
