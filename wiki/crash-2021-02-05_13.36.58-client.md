...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-05_13.36.58-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Everything's going to plan. No, really, that was supposed to happen. Time: 2/5/21 1:36 PM Description: Rendering overlay com.google.gson.JsonParseException: com.google.gson.stream.MalformedJsonException: Expected name at line 10 column 3 path $.animations.running at net.minecraft.util.JSONUtils.fromJson(JSONUtils.java:373) ~[forge:?] {re:classloading} at net.minecraft.util.JSONUtils.fromJson(JSONUtils.java:397) ~[forge:?] {re:classloading} at net.minecraft.uti
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-05_13.36.58-client.txt
