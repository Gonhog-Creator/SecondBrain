...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-18_14.26.46-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't be sad, have a hug! <3 Time: 12/18/20 2:26 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201

## Full Content
---- Minecraft Crash Report ----
// Don't be sad, have a hug! <3

Time: 12/18/20 2:26 PM
...
Details:
	...
	Exception message: net.minecraft.util.ResourceLocationException: Non [a-z0-9/._-] character in path of location: theancientworld:Raw Satyr Meat
Stacktrace:
	at net.minecraft.util.ResourceLocation.<init>(ResourceLocation.java:33) ~[forge:?] {re:classloading}
	...
	at com.gonhog.theancientworld.util.RegistryHandler.<clinit>(RegistryHandler.java:52) ~[?:?] {re:classloading}
	at com.gonhog.theancientworld.TheAncientWorld.<init>(TheAncientWorld.java:38) ~[?:?] {re:classloading}
	at sun.reflect.NativeConstructorAccessorImpl.newInstance0(Native Method) ~[?:1.8.0_275] {}
	at sun.reflect.NativeConstructorAccessorImpl.newInstance(NativeConstructorAccessorImpl.java:62) ~[?:1.8.0_275] {}
	at sun.reflect.DelegatingConstructorAccessorImpl.newInstance(DelegatingConstructorAccessorImpl.java:45) ~[?:1.8.0_275] {}
...
Details:
	...
	Memory: 688399664 bytes (656 MB) / 1732771840 bytes (1652 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 098e7a68-3902-4696-9e4c-4958ac7e427a

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-18_14.26.46-fml.txt
