...
Source: junk_drawer/github/DeltaDash/frontend/src/types/panel.ts.txt

Category: [[github-code]]

## Summary
export interface ArmorPanelLayer { id: string; panel_id: string; layer_index: number; material_id: string | null; orientation_degrees: number | null; layer_count: number; notes: string | null; }
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/types/panel.ts.txt
