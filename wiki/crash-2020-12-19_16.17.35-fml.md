...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-19_16.17.35-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't be sad, have a hug! <3 Time: 12/19/20 4:17 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201

## Full Content
---- Minecraft Crash Report ----
// Don't be sad, have a hug! <3

Time: 12/19/20 4:17 PM
...
Details:
	...
	Failure message: The Ancient World (theancientworld) has failed to load correctly
		java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.client.event.RenderPlayerEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
	Mod Version: 1.16.4 -1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.client.event.RenderPlayerEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
Stacktrace:
	at net.minecraftforge.eventbus.EventBus.addListener(EventBus.java:236) ~[eventbus-3.0.5-service.jar:?] {}
...
Details:
	...
	Memory: 624885480 bytes (595 MB) / 1679818752 bytes (1602 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 7a63254e-d5ff-421d-a2a7-b73a92f73e37

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-19_16.17.35-fml.txt
