...
Source: junk_drawer/github/TheAncientWorld/src/main/resources/data/theancientworld/worldgen/template_pool/fablehaven/start_pool.json.txt

Category: [[github-code]]

## Summary
{ "_comment0": "More info on template pools can be found here: https://minecraft.gamepedia.com/Custom_world_generation#JSON_format_8", "_comment1": "This is the name of the template pool itself. I tend to just put the file path and file name here with modid.", "name": "theancientworld:fablehaven/start_pool", "fallback": "minecraft:empty", "_comment3": "Here you can list as many nbt files or configured features to spawn.", "_comment4": "Do note that configured features needs a special element ent
...
## Full Content
{
  ...
  "name": "theancientworld:fablehaven/start_pool",
  ...
  "elements": [
    {
      ...
      "element": {
        ...
        "location": "theancientworld:fablehaven_house_part_one",
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/src/main/resources/data/theancientworld/worldgen/template_pool/fablehaven/start_pool.json.txt
