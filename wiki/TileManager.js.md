...
Source: junk_drawer/github/EvolutionSimSite/src/js/managers/TileManager.js.txt

Category: [[github-code]]

## Summary
import { logger } from '../utils/logger.js'; // Default tile properties const DEFAULT_TILE_PROPERTIES = { // Basic properties type: 'empty', state: 'gas',  // 'gas', 'liquid', or 'solid' // Physical properties temperature: 20,         // Celsius
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/managers/TileManager.js.txt
