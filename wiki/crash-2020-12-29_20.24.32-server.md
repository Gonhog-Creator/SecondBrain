...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-29_20.24.32-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // This doesn't make any sense! Time: 12/29/20 8:24 PM Description: Ticking block entity java.lang.NullPointerException: Ticking block entity at net.minecraft.world.World.tickBlockEntities(World.java:537) ~[forge:?] {re:classloading,pl:accesstransformer:B} at net.minecraft.world.server.ServerWorld.tick(ServerWorld.java:374) ~[forge:?] {re:classloading} at net.minecraft.server.MinecraftServer.updateTimeLightAndEntities(MinecraftServer.java:884) ~[forge:?] {re:clas
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-29_20.24.32-server.txt
