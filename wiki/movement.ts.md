...
Source: junk_drawer/github/PersonalWebsite/src/app/roasim/movement.ts.txt

Category: [[github-code]]

## Summary
import { BattleUnit } from './types'; export interface MovementResult { newPosition: number; moved: boolean; reason: string; } export interface TargetingResult { targets: BattleUnit[];
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/roasim/movement.ts.txt
