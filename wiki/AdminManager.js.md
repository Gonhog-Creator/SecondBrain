...
Source: junk_drawer/github/EvolutionSimSite/src/js/managers/AdminManager.js.txt

Category: [[github-code]]

## Summary
import { logger } from '../utils/logger.js'; /** * Manages admin-related functionality and UI */ export class AdminManager { constructor(app) { this.app = app; this.isAdmin = false; this.adminContainer = null;
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/managers/AdminManager.js.txt
