...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-04_01.09.58-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Who set us up the TNT? Time: 2/4/21 1:09 AM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java:164) ~[forge-1.16.5-geckoli
...
java.lang.NullPointerException: Rendering entity in world
	...
	at com.gonhog.theancientworld.entities.dirt_golem.DirtGolemEntity.predicate(DirtGolemEntity.java:56) ~[main/:?] {re:classloading}
...
Stacktrace:
	...
	at com.gonhog.theancientworld.entities.dirt_golem.DirtGolemEntity.predicate(DirtGolemEntity.java:56) ~[?:?] {re:classloading}
...
Details:
	...
	Entity's Exact location: -106.56, 4.00, 103.49
	Entity's Block location: World: (-107,4,103), Chunk: (at 5,0,7 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.dirt_golem.DirtGolemRender@4f98ac31
	Location: -0.17,-1.62,-1.57 - World: (-1,-2,-2), Chunk: (at 15,-1,14 in -1,-1; contains blocks -16,0,-16 to -1,255,-1), Region: (-1,-1; contains chunks -32,-32 to -1,-1, blocks -512,0,-512 to -1,255,-1)
	Rotation: 150.46875
	Delta: 0.53999853
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/101, l='ClientLevel', x=-106.39, y=4.00, z=105.06]]
	Chunk stats: Client Chunk Cache: 841, 467
	...
	Level time: 79607 game time, 6695 day time
	Server brand: forge
...
Details:
	...
	Memory: 1285657160 bytes (1226 MB) / 1886912512 bytes (1799 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: d02731e1-39da-45dd-a39e-8a61cb80b348
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-04_01.09.58-client.txt
