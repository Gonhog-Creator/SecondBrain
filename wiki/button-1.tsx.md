...
Source: junk_drawer/github/PersonalWebsite/src/components/ui/button-1.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import type { HTMLAttributes } from 'react'; interface GradientButtonProps extends HTMLAttributes<HTMLDivElement> { children?: React.ReactNode; width?: string; height?: string; onClick?: () => void; disabled?: boolean;
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/ui/button-1.tsx.txt
