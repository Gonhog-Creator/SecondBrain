...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.36.24-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // I feel sad now :( Time: 1/27/21 10:36 PM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java:164) ~[forge-1.16.5-geckolib-3

## Full Content
---- Minecraft Crash Report ----
// I feel sad now :(

Time: 1/27/21 10:36 PM
...
java.lang.NullPointerException: Rendering entity in world
	...
	at com.gonhog.theancientworld.entities.centaur.CentaurEntity.predicate(CentaurEntity.java:60) ~[main/:?] {re:classloading}
...
Stacktrace:
	...
	at com.gonhog.theancientworld.entities.centaur.CentaurEntity.predicate(CentaurEntity.java:60) ~[?:?] {re:classloading}
...
Details:
	...
	Entity's Exact location: -112.32, 4.00, 108.32
	Entity's Block location: World: (-113,4,108), Chunk: (at 15,0,12 in -8,6; contains blocks -128,0,96 to -113,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.centaur.CentaurRender@186d6033
	Location: -2.24,-1.39,5.95 - World: (-3,-2,5), Chunk: (at 13,-1,5 in -1,0; contains blocks -16,0,0 to -1,255,15), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
	Rotation: 0.0
	Delta: 0.0
Stacktrace:
...
Details:
	...
	Level time: 12083 game time, 12083 day time
	Server brand: forge
...
Details:
	...
	Memory: 1340074120 bytes (1277 MB) / 1982332928 bytes (1890 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: e662f3d6-8f7a-413c-9934-58b1f9d6b889
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.36.24-client.txt
