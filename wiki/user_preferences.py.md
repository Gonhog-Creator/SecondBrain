...
Source: junk_drawer/github/BudgetTool/backend/app/services/user_preferences.py.txt

Category: [[github-code]]

## Summary
import json import os from typing import Dict, List, Optional from pathlib import Path class UserPreferencesService: """Service for managing user-specific categorization preferences in JSON files""" def __init__(self, base_dir: str = "user_preferences"): self.base_dir = Path(base_dir)
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/app/services/user_preferences.py.txt
