...
Source: junk_drawer/github/RoADashboard/Parsing Tools/MapParser/ExcelToYamlMapCells.py.txt

Category: [[github-code]]

## Summary
import yaml import pandas as pd import re from collections import defaultdict def excel_to_yaml(excel_file_path, original_yaml_path, output_yaml_path): """ Import Excel file in the same format as MapCellsParser output and generate a new YAML file with updated values while preserving exact structure. """
...
## Metadata
- Source file: junk_drawer/github/RoADashboard/Parsing Tools/MapParser/ExcelToYamlMapCells.py.txt
