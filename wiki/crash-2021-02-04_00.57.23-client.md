...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-04_00.57.23-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Oh - I know what I did wrong! Time: 2/4/21 12:57 AM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java:164) ~[forge-1.16.5

## Full Content
---- Minecraft Crash Report ----
// Oh - I know what I did wrong!

Time: 2/4/21 12:57 AM
...
Details:
	...
	Entity's Exact location: -107.50, 4.00, 105.50
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.dirt_golem.DirtGolemRender@3462e99a
	Location: 0.54,-1.62,-1.07 - World: (0,-2,-2), Chunk: (at 0,-1,14 in 0,-1; contains blocks 0,0,-16 to 15,255,-1), Region: (0,-1; contains chunks 0,-32 to 31,-1, blocks 0,0,-512 to 511,255,-1)
	Rotation: 0.0
	Delta: 0.07997751
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/100, l='ClientLevel', x=-108.04, y=4.00, z=106.55]]
	...
	Level time: 79528 game time, 6616 day time
	Server brand: forge
...
Details:
	...
	Memory: 805551408 bytes (768 MB) / 1896349696 bytes (1808 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 32964bc7-40d4-438c-9d4d-91f1616ef96a
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-04_00.57.23-client.txt
