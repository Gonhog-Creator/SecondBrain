...
Source: junk_drawer/github/EvolutionSimSite/src/js/utils/logger.js.txt

Category: [[github-code]]

## Summary
/** * Logging utility with different log levels and formatting */ class Logger { constructor() { this.logLevels = { DEBUG: 0, INFO: 1, WARN: 2, ERROR: 3,
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/js/utils/logger.js.txt
