...
Source: junk_drawer/github/DeltaDash/backend/alembic.ini.txt
...
# If specified, requires the python>=3.9.
# or python-dateutil
...
# sqlalchemy.url is set from environment variable DATABASE_URL
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/alembic.ini.txt
