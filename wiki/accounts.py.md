...
Source: junk_drawer/github/BudgetTool/backend/app/routers/accounts.py.txt

Category: [[github-code]]

## Summary
from fastapi import APIRouter, Depends, HTTPException, Query from sqlalchemy.orm import Session from typing import List from app.database import get_db from app.models import Account as AccountModel, Transaction router = APIRouter() @router.get("/") def get_accounts(
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/app/routers/accounts.py.txt
