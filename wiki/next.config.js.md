...
Source: junk_drawer/github/PersonalWebsite/next.config.js.txt

Category: [[github-code]]

## Summary
/** @type {import('next').NextConfig} */ const path = require('path'); const isProd = process.env.NODE_ENV === 'production'; // Security headers const securityHeaders = [ { key: 'X-Content-Type-Options', value: 'nosniff',
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/next.config.js.txt
