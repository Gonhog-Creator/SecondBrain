...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_20.48.10-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Oops. Time: 2/12/21 8:48 PM Description: Ticking entity java.lang.NullPointerException: Ticking entity at com.gonhog.theancientworld.entities.TAWGolem.travel(TAWGolem.java:163) ~[?:?] {re:classloading} at net.minecraft.entity.LivingEntity.livingTick(LivingEntity.java:2600) ~[forge:?] {re:classloading} at net.minecraft.entity.MobEntity.livingTick(MobEntity.java:538) ~[forge:?] {re:classloading,pl:accesstransformer:B}

## Full Content
---- Minecraft Crash Report ----
// Oops.

Time: 2/12/21 8:48 PM
Description: Ticking entity

java.lang.NullPointerException: Ticking entity
	at com.gonhog.theancientworld.entities.TAWGolem.travel(TAWGolem.java:163) ~[?:?] {re:classloading}
...
Details:
	...
	Entity's Exact location: -105.14, 5.50, 107.80
	Entity's Block location: World: (-106,5,107), Chunk: (at 6,0,11 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
	Entity's Momentum: 0.00, -0.08, 0.00
	Entity's Passengers: [ServerPlayerEntity['Dev'/98, l='ServerLevel[Dev]', x=-105.14, y=7.45, z=107.80]]
...
-- Affected level --
Details:
	All players: 1 total; [ServerPlayerEntity['Dev'/98, l='ServerLevel[Dev]', x=-105.14, y=7.45, z=107.80]]
	...
	Level time: 214002 game time, 1444 day time
	Level name: Dev
...
Details:
	...
	Memory: 1127917000 bytes (1075 MB) / 1920991232 bytes (1832 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 5ff0d0a1-4000-4ac2-bac8-dcf33742c285
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/98, l='ServerLevel[Dev]', x=-105.14, y=7.45, z=107.80]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_20.48.10-server.txt
