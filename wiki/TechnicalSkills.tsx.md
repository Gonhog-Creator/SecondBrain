...
Source: junk_drawer/github/PersonalWebsite/src/components/TechnicalSkills/TechnicalSkills.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { Icon } from '@iconify/react'; export const TechnicalSkills = () => { const skills = [ { name: 'Lightroom', icon: 'logos:adobe-lightroom' }, { name: 'Photoshop', icon: 'logos:adobe-photoshop' }, { name: 'Excel', icon: 'vscode-icons:file-type-excel' }, { name: 'Arduino', icon: 'logos:arduino' },
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/TechnicalSkills/TechnicalSkills.tsx.txt
