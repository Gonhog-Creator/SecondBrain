...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.48.34-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't be sad, have a hug! <3 Time: 3/10/21 11:48 AM Description: Exception ticking world java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSpawnEvent.CheckSpawn at net.minecraftforge.eventbus.api.Event.setCanceled(Event.java:95) ~[eventbus-4.0.0.jar:?] {} at com.gonhog.theancientworld.util.StructureHelpers.canCustomMobSpawn(StructureHelpers.java:134) ~[
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.48.34-server.txt
