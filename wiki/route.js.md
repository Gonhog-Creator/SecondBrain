...
Source: junk_drawer/github/PersonalWebsite/src/app/api/send-email/route.js.txt

Category: [[github-code]]

## Summary
import { NextResponse } from 'next/server'; import nodemailer from 'nodemailer'; import sgMail from '@sendgrid/mail'; // Configure SendGrid with API key from environment variables if (process.env.SENDGRID_API_KEY) { sgMail.setApiKey(process.env.SENDGRID_API_KEY); } const isProduction = process.env.NODE_ENV === 'production';
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/api/send-email/route.js.txt
