...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-03_20.38.46-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't be sad. I'll do better next time, I promise! Time: 2/3/21 8:38 PM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(AnimationController.java
...
Details:
	...
	Entity's Exact location: -110.25, 4.00, 108.68
	Entity's Block location: World: (-111,4,108), Chunk: (at 1,0,12 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.dirt_golem.DirtGolemRender@757c685d
	Location: -1.66,-1.62,0.21 - World: (-2,-2,0), Chunk: (at 14,-1,0 in -1,0; contains blocks -16,0,0 to -1,255,15), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
	Rotation: -49.21875
	Delta: 0.47999096
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/126, l='ClientLevel', x=-108.60, y=4.00, z=108.47]]
	...
	Level time: 66733 game time, 4609 day time
	Server brand: forge
...
Details:
	...
	Memory: 832274240 bytes (793 MB) / 1901592576 bytes (1813 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 6a1ca23d-2d67-47e6-babb-258cba1d8a64
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-03_20.38.46-client.txt
