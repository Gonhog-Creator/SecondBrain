...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-31_11.17.16-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // On the bright side, I bought you a teddy bear! Time: 1/31/21 11:17 AM Description: Rendering entity in world software.bernie.geckolib3.geo.exception.GeoModelException: theancientworld:geo/satyr.geo.json: Could not find model. at software.bernie.geckolib3.model.AnimatedGeoModel.getModel(AnimatedGeoModel.java:107) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.renderers.geo.GeoEntityRende

## Full Content
---- Minecraft Crash Report ----
// On the bright side, I bought you a teddy bear!

Time: 1/31/21 11:17 AM
Description: Rendering entity in world

software.bernie.geckolib3.geo.exception.GeoModelException: theancientworld:geo/satyr.geo.json: Could not find model.
	at software.bernie.geckolib3.model.AnimatedGeoModel.getModel(AnimatedGeoModel.java:107) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading}
	at software.bernie.geckolib3.renderers.geo.GeoEntityRenderer.render(GeoEntityRenderer.java:121) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading}
...
Stacktrace:
	at software.bernie.geckolib3.model.AnimatedGeoModel.getModel(AnimatedGeoModel.java:107) ~[geckolib3:3.0.4a] {re:classloading}
	at software.bernie.geckolib3.renderers.geo.GeoEntityRenderer.render(GeoEntityRenderer.java:121) ~[geckolib3:3.0.4a] {re:classloading}
...
Details:
	Entity Type: theancientworld:satyr (com.gonhog.theancientworld.entities.satyr.SatyrEntity)
	Entity ID: 31
	Entity Name: entity.theancientworld.satyr
	Entity's Exact location: -67.33, 4.00, 72.79
	Entity's Block location: World: (-68,4,72), Chunk: (at 12,0,8 in -5,4; contains blocks -80,0,64 to -65,255,79), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.satyr.SatyrRender@5c5c784c
	Location: 31.49,-2.62,-59.07 - World: (31,-3,-60), Chunk: (at 15,-1,4 in 1,-4; contains blocks 16,0,-64 to 31,255,-49), Region: (0,-1; contains chunks 0,-32 to 31,-1, blocks 0,0,-512 to 511,255,-1)
	Rotation: 104.0625
	Delta: 0.8600044
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/100, l='ClientLevel', x=-98.81, y=5.00, z=131.86]]
	...
	Level time: 33641 game time, 6288 day time
	Server brand: forge
...
Details:
	...
	Memory: 1315104472 bytes (1254 MB) / 1919942656 bytes (1831 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: ddf84a06-1d06-49af-8d12-80cf91866156
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-31_11.17.16-client.txt
