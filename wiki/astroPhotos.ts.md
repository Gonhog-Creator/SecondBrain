...
Source: junk_drawer/github/PersonalWebsite/src/data/astroPhotos.ts.txt

Category: [[github-code]]

## Summary
import { AstroPhoto } from "@/types/astro"; // Helper function to format dates consistently const formatDate = (dateString: string) => { const date = new Date(dateString); return date.toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' });
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/data/astroPhotos.ts.txt
