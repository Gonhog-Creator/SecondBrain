...
Source: junk_drawer/github/DeltaDash/frontend/src/api/shots.ts.txt

Category: [[github-code]]

## Summary
import { apiClient } from './client'; export interface Shot { id: string; test_session_id: string | null; panel_id: string | null; ammunition_id: string | null; shot_pattern_position_id: string | null; shot_number: number | null; measured_velocity_fps: number | null;
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/frontend/src/api/shots.ts.txt
