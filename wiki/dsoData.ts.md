...
Source: junk_drawer/github/PersonalWebsite/src/data/dsoData.ts.txt

Category: [[github-code]]

## Summary
import { DSOImage } from "@/types/astro"; export const dsoImages: DSOImage[] = [ { id: 'dso-1', title: 'Casper Ghost Nebula (M78)', date: '2024-12-02', shortDescription: 'A striking reflection nebula in Orion, M78 is the brightest in its group, illuminated by young, hot stars. Known for its ghostly appearance, it lies 1,350 light-years away and is part of the Orion B molecular cloud complex.', fullDescription: 'Messier 78 (also known as M78 or NGC 2068) is a reflection nebula in the constellatio
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/data/dsoData.ts.txt
