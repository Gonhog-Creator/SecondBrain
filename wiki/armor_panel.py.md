...
Source: junk_drawer/github/DeltaDash/backend/app/db/models/armor_panel.py.txt

Category: [[github-code]]

## Summary
from sqlalchemy import Column, String, Numeric, Integer, DateTime, ForeignKey, func from sqlalchemy.dialects.postgresql import UUID import uuid from app.db.base import Base class ArmorPanel(Base): __tablename__ = "armor_panels"
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/app/db/models/armor_panel.py.txt
