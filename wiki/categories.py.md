...
Source: junk_drawer/github/BudgetTool/backend/app/routers/categories.py.txt

Category: [[github-code]]

## Summary
from fastapi import APIRouter, Depends, HTTPException from sqlalchemy.orm import Session from typing import List from app.database import get_db from app.models import Category as CategoryModel, Transaction as TransactionModel from app.schemas import CategoryCreate, Category from app.services.categorization import CategorizationService router = APIRouter() categorization_service = CategorizationService()
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/app/routers/categories.py.txt
