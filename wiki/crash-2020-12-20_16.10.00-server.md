...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_16.10.00-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Why is it breaking :( Time: 12/20/20 4:10 PM Description: Ticking entity java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSetAttackTargetEvent at net.minecraftforge.eventbus.api.Event.setCanceled(Event.java:95) ~[eventbus-3.0.5-service.jar:?] {} at com.gonhog.theancientworld.events.ClientEventHandler.makePlayerUntargetable(ClientEventHandler.java:39) ~

## Full Content
---- Minecraft Crash Report ----
// Why is it breaking :(

Time: 12/20/20 4:10 PM
...
java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSetAttackTargetEvent
	...
	at com.gonhog.theancientworld.events.ClientEventHandler.makePlayerUntargetable(ClientEventHandler.java:39) ~[main/:?] {re:classloading}
...
Details:
	...
	Entity ID: 344
	Entity Name: Zombie
	Entity's Exact location: -204.50, 78.00, -252.50
	Entity's Block location: World: (-205,78,-253), Chunk: (at 3,4,3 in -13,-16; contains blocks -208,0,-256 to -193,255,-241), Region: (-1,-1; contains chunks -32,-32 to -1,-1, blocks -512,0,-512 to -1,255,-1)
...
-- Affected level --
Details:
	All players: 1 total; [ServerPlayerEntity['Dev'/187, l='ServerLevel[New World]', x=-204.29, y=78.00, z=-249.73]]
	...
	Level time: 53515 game time, 1776 day time
	Level name: New World
	Level game mode: Game mode: creative (ID 1). Hardcore: false. Cheats: true
	Level weather: Rain time: 105248 (now: false), thunder time: 15552 (now: false)
...
Details:
	...
	Memory: 615661984 bytes (587 MB) / 1878523904 bytes (1791 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 16a91a87-b519-4013-8340-436b4fe5a5d2
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/187, l='ServerLevel[New World]', x=-204.29, y=78.00, z=-249.73]]
	Data Packs: vanilla, mod:theancientworld, mod:forge
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_16.10.00-server.txt
