...
Source: junk_drawer/github/EvolutionSimSite/src/engine/TemperatureSystem.cpp.txt

Category: [[github-code]]

## Summary
#include "TemperatureSystem.hpp" #include <cmath> #include <algorithm> TemperatureSystem::TemperatureSystem(uint32_t width, uint32_t height, double ambientTemp) : grid{std::vector<std::vector<Cell>>(height, std::vector<Cell>(width)), width, height, ambientTemp} { initialize(); } void TemperatureSystem::initialize() {
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/engine/TemperatureSystem.cpp.txt
