...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.28.16-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Why did you do that? Time: 1/27/21 10:28 PM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16

## Full Content
---- Minecraft Crash Report ----
// Why did you do that?

Time: 1/27/21 10:28 PM
...
Stacktrace:
	at net.minecraft.client.gui.ScreenManager.registerFactory(ScreenManager.java:68) ~[forge:?] {re:classloading,pl:accesstransformer:B,pl:runtimedistcleaner:A}
-- MOD theancientworld --
Details:
	Mod File: main
	Failure message: The Ancient World (theancientworld) encountered an error during the sided_setup event phase
		java.lang.IllegalStateException: Duplicate registration for theancientworld:test_block
	Mod Version: 1.16.4 -1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.IllegalStateException: Duplicate registration for theancientworld:test_block
Stacktrace:
	at net.minecraft.client.gui.ScreenManager.registerFactory(ScreenManager.java:68) ~[forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading,pl:accesstransformer:B,pl:runtimedistcleaner:A}
	at com.gonhog.theancientworld.util.ClientSetup.init(ClientSetup.java:23) ~[main/:?] {re:classloading}
	at net.minecraftforge.eventbus.ASMEventHandler_22_ClientSetup_init_FMLClientSetupEvent.invoke(.dynamic) ~[?:?] {}
...
Details:
	...
	Memory: 938355216 bytes (894 MB) / 1695547392 bytes (1617 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	FML Language Providers: 
		...
		minecraft@1
	Mod List: 
		client-extra.jar                                  |Minecraft                     |minecraft                     |1.16.4              |ENQUEUE_IM|a1:d4:5e:04:4f:d3:d6:e0:7b:37:97:cf:77:b0:de:ad:4a:47:ce:8c:96:49:5f:0a:cf:8c:ae:b2:6d:4b:8a:3f
		main                                              |The Ancient World             |theancientworld               |1.16.4 -1.0         |ERROR     |NOSIGNATURE
		forge-1.16.4-35.1.4_mapped_snapshot_20201028-1.16.|Forge                         |forge                         |35.1.4              |ENQUEUE_IM|NOSIGNATURE
		curios-forge-1.16.4-4.0.3.4_mapped_snapshot_202010|Curios API                    |curios                        |1.16.4-4.0.3.4      |ENQUEUE_IM|NOSIGNATURE
		forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201|GeckoLib                      |geckolib3                     |3.0.4a              |ENQUEUE_IM|NOSIGNATURE
	Crash Report UUID: f47283fb-1cb6-46e5-b905-d0f451f3414d

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.28.16-fml.txt
