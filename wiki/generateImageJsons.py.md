...
Source: junk_drawer/github/PersonalWebsite/scripts/generateImageJsons.py.txt

Category: [[github-code]]

## Summary
import os import json import random from pathlib import Path from typing import List, Dict, Any def scan_images(directory: str) -> List[Dict[str, Any]]: """Scan a directory recursively for image files and return their metadata.""" image_extensions = {'.jpg', '.jpeg', '.png', '.webp'} excluded_paths = {
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/scripts/generateImageJsons.py.txt
