...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-22_20.18.55-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // This is a token for 1 free hug. Redeem at your nearest Mojangsta: [~~HUG~~] Time: 2/22/21 8:18 PM Description: Ticking entity java.lang.IllegalArgumentException: Can't find attribute minecraft:generic.flying_speed at net.minecraft.entity.ai.attributes.AttributeModifierMap.getModifier(AttributeModifierMap.java:21) ~[forge:?] {re:classloading} at net.minecraft.entity.ai.attributes.AttributeModifierMap.getAttributeValue(AttributeModifierMap.java:28) ~[forge:?] {r
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-22_20.18.55-server.txt
