...
Source: junk_drawer/github/PersonalWebsite/src/components/TechnicalSkills/index.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { Icon } from '@iconify/react'; export default function TechnicalSkills() { const skills = [ { name: 'Lightroom', icon: 'logos:adobe-lightroom' }, { name: 'Photoshop', icon: 'logos:adobe-photoshop' }, { name: 'Excel', icon: 'vscode-icons:file-type-excel' }, { name: 'Arduino', icon: 'logos:arduino' },
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/TechnicalSkills/index.tsx.txt
