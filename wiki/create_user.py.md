...
Source: junk_drawer/github/DeltaDash/backend/create_user.py.txt

Category: [[github-code]]

## Summary
""" Script to generate user records for direct database insertion. Run this script to get SQL INSERT statements for creating users. """ import uuid def generate_user_sql(username: str, hashed_password: str, full_name: str = None, role: str = "viewer", is_admin: bool = False): """Generate SQL INSERT statement for a user with a pre-hashed password."""
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/create_user.py.txt
