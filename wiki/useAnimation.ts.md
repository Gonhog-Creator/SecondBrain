...
Source: junk_drawer/github/PersonalWebsite/src/hooks/useAnimation.ts.txt

Category: [[github-code]]

## Summary
'use client'; import { useCallback, useEffect, useRef, useState } from 'react'; import { usePathname } from 'next/navigation'; /** * Hook to handle page transition animations */ export function usePageTransition() { const [isTransitioning, setIsTransitioning] = useState(false);
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/hooks/useAnimation.ts.txt
