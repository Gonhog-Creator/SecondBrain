...
Source: junk_drawer/github/PersonalWebsite/src/lib/server/redis-actions.ts.txt

Category: [[github-code]]

## Summary
'use server'; import { redis } from '@/lib/kv'; interface Submission { id: string; type: string; data: { name: string; submittedBy?: string;
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/lib/server/redis-actions.ts.txt
