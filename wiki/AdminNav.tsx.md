...
Source: junk_drawer/github/PersonalWebsite/src/components/AdminNav.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { useSession, signOut } from 'next-auth/react'; import Link from 'next/link'; import { usePathname } from 'next/navigation'; export function AdminNav() { const { data: session } = useSession(); const pathname = usePathname();
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/AdminNav.tsx.txt
