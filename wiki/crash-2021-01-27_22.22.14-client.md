...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.22.14-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Shall we play a game? Time: 1/27/21 10:22 PM Description: Rendering entity in world software.bernie.geckolib3.geo.exception.GeoModelException: geckolib3:geo/centaur.geo.json: Could not find model. at software.bernie.geckolib3.model.AnimatedGeoModel.getModel(AnimatedGeoModel.java:107) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.renderers.geo.GeoEntityRenderer.render(GeoEntityRenderer.

## Full Content
---- Minecraft Crash Report ----
// Shall we play a game?

Time: 1/27/21 10:22 PM
Description: Rendering entity in world

software.bernie.geckolib3.geo.exception.GeoModelException: geckolib3:geo/centaur.geo.json: Could not find model.
...
Details:
	Entity Type: theancientworld:centaur (com.gonhog.theancientworld.entities.centaur.CentaurEntity)
	Entity ID: 16
	Entity Name: entity.theancientworld.centaur
	Entity's Exact location: -66.69, 4.00, 125.48
	Entity's Block location: World: (-67,4,125), Chunk: (at 13,0,13 in -5,7; contains blocks -80,0,112 to -65,255,127), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.centaur.CentaurRender@1760e688
	Location: 43.39,-1.39,23.11 - World: (43,-2,23), Chunk: (at 11,-1,7 in 2,1; contains blocks 32,0,16 to 47,255,31), Region: (0,0; contains chunks 0,0 to 31,31, blocks 0,0,0 to 511,255,511)
	Rotation: -54.84375
	Delta: 0.0
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/94, l='ClientLevel', x=-110.08, y=5.39, z=102.37]]
	...
	Level time: 12055 game time, 12055 day time
	Server brand: forge
...
Details:
	...
	Memory: 1242003608 bytes (1184 MB) / 1905262592 bytes (1817 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: d54e8d6a-3b05-492c-80b8-6d4f19ccc60f
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-01-27_22.22.14-client.txt
