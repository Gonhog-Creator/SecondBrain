...
Source: junk_drawer/github/DeltaVision/app/utils/geometry.py.txt

Category: [[github-code]]

## Summary
import numpy as np from typing import List, Tuple, Optional from shapely.geometry import Point, Polygon, LineString import math class GeometryUtils: """Utility functions for geometric calculations""" @staticmethod def point_in_polygon(point: Tuple[float, float], polygon: List[Tuple[float, float]]) -> bool:
...
## Metadata
- Source file: junk_drawer/github/DeltaVision/app/utils/geometry.py.txt
