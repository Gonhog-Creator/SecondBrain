...
Source: junk_drawer/github/PersonalWebsite/src/app/roasim/troop-data.ts.txt

Category: [[github-code]]

## Summary
import { TroopStats } from './types'; // Troop Stats Data export const TROOP_STATS: Record<string, TroopStats> = { // Tier 1 porter: { name: 'Porter', tier: 1, type: 'infantry', attack: 1, rangedAttack: 0, health: 45, defense: 10, speed: 100, range: 0, load: 200, upkeep: 2, power: 1 }, conscript: {
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/app/roasim/troop-data.ts.txt
