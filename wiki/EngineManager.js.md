...
Source: junk_drawer/github/EvolutionSimSite/src/jsLegacy/managers/EngineManager.js.txt

Category: [[github-code]]

## Summary
import { eventBus } from '../core/EventBus.js'; import { config } from '../core/Config.js'; import { logger } from '../utils/logger.js'; /** * Manages the game engine and simulation */ export class EngineManager { constructor() { // Simulation state
...
## Metadata
- Source file: junk_drawer/github/EvolutionSimSite/src/jsLegacy/managers/EngineManager.js.txt
