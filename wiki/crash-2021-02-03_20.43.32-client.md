...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-03_20.43.32-client.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Everything's going to plan. No, really, that was supposed to happen. Time: 2/3/21 8:43 PM Description: Rendering entity in world java.lang.NullPointerException: Rendering entity in world at software.bernie.geckolib3.model.AnimatedGeoModel.getAnimation(AnimatedGeoModel.java:98) ~[forge-1.16.5-geckolib-3.0.4a_mapped_snapshot_20201028-1.16.3.jar:3.0.4a] {re:classloading} at software.bernie.geckolib3.core.controller.AnimationController.lambda$setAnimation$0(Animat
...
Details:
	...
	Entity's Exact location: -108.19, 4.00, 108.45
...
-- Renderer details --
Details:
	Assigned renderer: com.gonhog.theancientworld.entities.dirt_golem.DirtGolemRender@58690f5e
	Location: -1.42,-1.62,-0.91 - World: (-2,-2,-1), Chunk: (at 14,-1,15 in -1,-1; contains blocks -16,0,-16 to -1,255,-1), Region: (-1,-1; contains chunks -32,-32 to -1,-1, blocks -512,0,-512 to -1,255,-1)
	Rotation: -198.28125
	Delta: 0.700014
Stacktrace:
...
-- Affected level --
Details:
	All players: 1 total; [ClientPlayerEntity['Dev'/126, l='ClientLevel', x=-106.79, y=4.00, z=109.35]]
	...
	Level time: 67658 game time, 5534 day time
	Server brand: forge
...
Details:
	...
	Memory: 740192352 bytes (705 MB) / 1871183872 bytes (1784 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 79912b4c-831b-4179-9569-d454ecbac3e1
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-03_20.43.32-client.txt
