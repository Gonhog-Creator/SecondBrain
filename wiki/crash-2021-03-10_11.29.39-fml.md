...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.29.39-fml.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Everything's going to plan. No, really, that was supposed to happen. Time: 3/10/21 11:29 AM Description: Mod loading error has occurred java.lang.Exception: Mod Loading has failed at net.minecraftforge.fml.CrashReportExtender.dumpModLoadingCrashReport(CrashReportExtender.java:85) ~[forge-1.16.5-36.0.22_mapped_snapshot_20201028-1.16.3-recomp.jar:?] {re:classloading} at net.minecraftforge.fml.client.ClientModLoader.completeModLoading(ClientModLoader.java:188) ~[

## Full Content
---- Minecraft Crash Report ----
// Everything's going to plan. No, really, that was supposed to happen.

Time: 3/10/21 11:29 AM
...
Details:
	...
	Failure message: The Ancient World (theancientworld) has failed to load correctly
		java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.event.entity.living.LivingSpawnEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
	Mod Version: 1.16.5 - 1.0
	Mod Issue URL: http://my.issue.tracker/
	Exception message: java.lang.IllegalArgumentException: Listener for event class net.minecraftforge.event.entity.living.LivingSpawnEvent takes an argument that is not a subtype of the base type interface net.minecraftforge.fml.event.lifecycle.IModBusEvent
Stacktrace:
	at net.minecraftforge.eventbus.EventBus.addListener(EventBus.java:236) ~[eventbus-4.0.0.jar:?] {}
	...
	at com.gonhog.theancientworld.TheAncientWorld.<init>(TheAncientWorld.java:72) ~[?:?] {re:classloading}
...
Details:
	...
	Memory: 1259701704 bytes (1201 MB) / 1720713216 bytes (1641 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 130a58e9-09b7-4d99-846e-536d42cf46e4

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-03-10_11.29.39-fml.txt
