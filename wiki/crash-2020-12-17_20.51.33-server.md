...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-17_20.51.33-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Don't be sad. I'll do better next time, I promise! Time: 12/17/20 8:51 PM Description: Ticking player java.lang.ArrayIndexOutOfBoundsException: 4 at java.util.Arrays$ArrayList.get(Arrays.java:3841) ~[?:1.8.0_275] {} at net.minecraft.util.NonNullList.get(NonNullList.java:45) ~[forge:?] {re:classloading} at net.minecraft.entity.player.PlayerInventory.armorItemInSlot(PlayerInventory.java:555) ~[forge:?] {re:classloading}

## Full Content
---- Minecraft Crash Report ----
// Don't be sad. I'll do better next time, I promise!

Time: 12/17/20 8:51 PM
...
java.lang.ArrayIndexOutOfBoundsException: 4
	...
	at com.gonhog.theancientworld.armor.AdamantArmorItem.onArmorTick(AdamantArmorItem.java:28) ~[?:?] {re:classloading}
...
Details:
	...
	Entity ID: 175
	Entity Name: Dev
	Entity's Exact location: -201.92, 78.00, -249.82
	Entity's Block location: World: (-202,78,-250), Chunk: (at 6,4,6 in -13,-16; contains blocks -208,0,-256 to -193,255,-241), Region: (-1,-1; contains chunks -32,-32 to -1,-1, blocks -512,0,-512 to -1,255,-1)
...
Details:
	...
	Memory: 1218975352 bytes (1162 MB) / 1907884032 bytes (1819 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 4466c46c-2cc8-4ba8-aa46-5082aae8e85b
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/175, l='ServerLevel[New World]', x=-201.92, y=78.00, z=-249.82]]
	Data Packs: vanilla, mod:theancientworld, mod:forge
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-17_20.51.33-server.txt
