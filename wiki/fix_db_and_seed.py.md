...
Source: junk_drawer/github/DeltaDash/backend/scripts/fix_db_and_seed.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Fix database schema and seed users. """ import sys import os sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) import sqlite3 import uuid
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/scripts/fix_db_and_seed.py.txt
