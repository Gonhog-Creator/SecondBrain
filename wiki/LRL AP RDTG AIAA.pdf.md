...
Source: junk_drawer/LRL AP RDTG AIAA.pdf

Category: [[other]]

## Summary
ROTATING DETONATION TURBINE GENERATOR LIQUID ROCKETRY LAB ADVANCED PROJECTS April 4th 2025 Personnel Donovan Ngum Systems Lead
...
❏
Latin Hypercube Sampling (30 samples)
❏
...
Euler’s Turbomachinery Equation: P = ⍵ṁ(V3r3-V2r2)
Isentropic, 0D MATLAB model
Analyzed for power target of 3kW

Advanced Design Technology TURBOdesign
❏
❏
❏

Numerical blade generator from set on inlet
conditions
Inverse solver uses geometric conditions to generate
blade
Manufacturing modiﬁcations created from software

Aerodynamics Solutions ADSCFD
❏
❏
❏

Specialized turbomachinery CFD code
Integrated meshing and solver
20% eﬃciency prediction with current blade design

Manufacturing - Turbine
Mill Turn Operations (rotor)
❏
Completed by NC State’s CAMAL lab
❏
303 stainless steel stock
❏
Major diameters turned down from stock
❏
Full 4 axis milling of blades
❏
Indicator for checking runout
CNC Mill Operations (stator)
❏
Thread milling
...
## Metadata
- Source file: junk_drawer/LRL AP RDTG AIAA.pdf
