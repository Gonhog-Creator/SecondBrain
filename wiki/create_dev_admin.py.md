...
Source: junk_drawer/github/DeltaDash/backend/create_dev_admin.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Development-only script to create an admin user. This should only be used in development environment, never in production. """ import os import sys from sqlalchemy.orm import Session
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/create_dev_admin.py.txt
