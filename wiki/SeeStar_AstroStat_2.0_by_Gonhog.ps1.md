...
Source: junk_drawer/github/SeeStar-AstroStat-2.0/SeeStar_AstroStat_2.0_by_Gonhog.ps1.txt

Category: [[github-code]]

## Summary
# ============================== # SeeStar AstroStat 2.0 by Gonhog # A smart PowerShell utility that analyzes astrophotography session data from SeeStar S50 (or similar FIT/FITS datasets). # It automatically scans _sub and _mosaic_sub folders, counts total frames, exposure times, and failed captures — then outputs a clean, color-coded summary with per-object and global statistics. # Color refinement + cleaner summary # ============================== # Handle command line parameters param( [switc
...
## Metadata
- Source file: junk_drawer/github/SeeStar-AstroStat-2.0/SeeStar_AstroStat_2.0_by_Gonhog.ps1.txt
