...
Source: junk_drawer/github/DeltaDash/backend/generate_admin_sql.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Generate SQL for creating development admin user. This outputs SQL that you can run directly in your database. """ import uuid def generate_admin_sql():
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/generate_admin_sql.py.txt
