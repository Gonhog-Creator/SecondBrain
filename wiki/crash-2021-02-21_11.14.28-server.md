...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-21_11.14.28-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Shall we play a game? Time: 2/21/21 11:14 AM Description: Ticking player java.lang.ClassCastException: net.minecraft.entity.EntityType cannot be cast to net.minecraft.util.IItemProvider at com.gonhog.theancientworld.entities.quick_hit_arrow.QuickHitArrowEntity.getArrowStack(QuickHitArrowEntity.java:32) ~[?:?] {re:classloading} at net.minecraft.entity.projectile.AbstractArrowEntity.onCollideWithPlayer(AbstractArrowEntity.java:511) ~[forge:?] {re:classloading} a
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-21_11.14.28-server.txt
