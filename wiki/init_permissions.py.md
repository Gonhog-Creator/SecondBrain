...
Source: junk_drawer/github/DeltaDash/backend/scripts/init_permissions.py.txt

Category: [[github-code]]

## Summary
#!/usr/bin/env python3 """ Initialize permissions and seed users. This script adds the is_admin column and creates test users. """ import sys import os sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) import sqlite3
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/scripts/init_permissions.py.txt
