...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_16.12.16-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Oops. Time: 12/20/20 4:12 PM Description: Ticking entity java.lang.UnsupportedOperationException: Attempted to call Event#setCanceled() on a non-cancelable event of type: net.minecraftforge.event.entity.living.LivingSetAttackTargetEvent at net.minecraftforge.eventbus.api.Event.setCanceled(Event.java:95) ~[eventbus-3.0.5-service.jar:?] {} at com.gonhog.theancientworld.events.ClientEventHandler.makePlayerUntargetable(ClientEventHandler.java:39) ~[main/:?] {re:cl

## Full Content
---- Minecraft Crash Report ----
// Oops.

Time: 12/20/20 4:12 PM
...
-- Affected level --
Details:
	All players: 1 total; [ServerPlayerEntity['Dev'/187, l='ServerLevel[New World]', x=-203.16, y=78.00, z=-250.88]]
	...
	Level time: 53527 game time, 1788 day time
	Level name: New World
	Level game mode: Game mode: creative (ID 1). Hardcore: false. Cheats: true
	Level weather: Rain time: 105236 (now: false), thunder time: 15540 (now: false)
...
Details:
	...
	Memory: 1130111856 bytes (1077 MB) / 1919942656 bytes (1831 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 5077a088-840c-4ef8-a5fc-90fa83c31ee3
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/187, l='ServerLevel[New World]', x=-203.16, y=78.00, z=-250.88]]
	Data Packs: vanilla, mod:theancientworld, mod:forge
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2020-12-20_16.12.16-server.txt
