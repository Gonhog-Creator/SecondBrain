...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_09.10.36-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Sorry :( Time: 2/12/21 9:10 AM Description: Ticking entity java.lang.NullPointerException: Ticking entity at com.gonhog.theancientworld.entities.TAWGolem.travel(TAWGolem.java:165) ~[?:?] {re:classloading} at net.minecraft.entity.LivingEntity.livingTick(LivingEntity.java:2600) ~[forge:?] {re:classloading} at net.minecraft.entity.MobEntity.livingTick(MobEntity.java:538) ~[forge:?] {re:classloading,pl:accesstransformer:B}
...
## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-12_09.10.36-server.txt
