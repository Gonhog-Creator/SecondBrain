...
Source: junk_drawer/github/PersonalWebsite/src/components/Photography/WorldMap.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { useState, useCallback } from 'react'; // List of countries with galleries and their coordinates [x, y] in the SVG const COUNTRIES = [ { code: 'US', name: 'United States', x: '25%', y: '30%' }, { code: 'AR', name: 'Argentina', x: '30%', y: '80%' }, { code: 'CH', name: 'Switzerland', x: '50%', y: '35%' }, { code: 'DE', name: 'Germany', x: '52%', y: '30%' },
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/Photography/WorldMap.tsx.txt
