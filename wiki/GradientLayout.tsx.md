...
Source: junk_drawer/github/PersonalWebsite/src/components/GradientLayout.tsx.txt

Category: [[github-code]]

## Summary
'use client'; import { useEffect } from 'react'; export default function GradientLayout({ children }: { children: React.ReactNode }) { useEffect(() => { // This will be executed only on the client side const style = document.createElement('style'); style.textContent = ` @property --pos-x { syntax: '<percentage>'; initial-value: 11.14%; inherits: false; }
...
## Metadata
- Source file: junk_drawer/github/PersonalWebsite/src/components/GradientLayout.tsx.txt
