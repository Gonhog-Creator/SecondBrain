...
Source: junk_drawer/github/BudgetTool/backend/app/parsers/pdf_parser.py.txt

Category: [[github-code]]

## Summary
from typing import List, Dict, Any from datetime import datetime import pdfplumber import re from .base_parser import BaseParser class PDFParser(BaseParser): """Parser for PDF bank statements""" def can_parse(self, filename: str, content: bytes) -> bool:
...
## Metadata
- Source file: junk_drawer/github/BudgetTool/backend/app/parsers/pdf_parser.py.txt
