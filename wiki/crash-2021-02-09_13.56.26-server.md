...
Source: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_13.56.26-server.txt

Category: [[github-code]]

## Summary
---- Minecraft Crash Report ---- // Quite honestly, I wouldn't worry myself about that. Time: 2/9/21 1:56 PM Description: Ticking player java.lang.NullPointerException: Ticking player at java.util.Objects.requireNonNull(Objects.java:203) ~[?:1.8.0_275] {} at com.gonhog.theancientworld.items.potionRings.PotionRingEffectHandler.removeEffect(PotionRingEffectHandler.java:42) ~[main/:?] {re:classloading} at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:47) ~[main
...
java.lang.NullPointerException: Ticking player
	...
	at com.gonhog.theancientworld.items.potionRings.RegenRing.inventoryTick(RegenRing.java:47) ~[main/:?] {re:classloading}
...
Details:
	...
	Entity ID: 115
	Entity Name: Dev
	Entity's Exact location: -107.41, 4.00, 105.21
	Entity's Block location: World: (-108,4,105), Chunk: (at 4,0,9 in -7,6; contains blocks -112,0,96 to -97,255,111), Region: (-1,0; contains chunks -32,0 to -1,31, blocks -512,0,0 to -1,255,511)
...
Details:
	...
	Memory: 557673832 bytes (531 MB) / 1875902464 bytes (1789 MB) up to 3817865216 bytes (3641 MB)
	CPUs: 4
	...
	Crash Report UUID: 2f6d79f1-e129-4299-8f65-5dc7f22ba467
	Player Count: 1 / 8; [ServerPlayerEntity['Dev'/115, l='ServerLevel[Dev]', x=-107.41, y=4.00, z=105.21]]
	Data Packs: vanilla, mod:theancientworld, mod:forge, mod:curios, mod:geckolib3 (incompatible)
	Type: Integrated Server (map_client.txt)
	Is Modded: Definitely; Client brand changed to 'forge'

## Metadata
- Source file: junk_drawer/github/TheAncientWorld/run/crash-reports/crash-2021-02-09_13.56.26-server.txt
