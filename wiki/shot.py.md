...
Source: junk_drawer/github/DeltaDash/backend/app/db/models/shot.py.txt

Category: [[github-code]]

## Summary
from sqlalchemy import Column, String, Numeric, Boolean, Integer, DateTime, ForeignKey, func from sqlalchemy.dialects.postgresql import UUID import uuid from app.db.base import Base class Shot(Base): __tablename__ = "shots"
...
## Metadata
- Source file: junk_drawer/github/DeltaDash/backend/app/db/models/shot.py.txt
