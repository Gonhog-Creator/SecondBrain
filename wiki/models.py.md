...
Source: junk_drawer/github/DeltaVision/app/db/models.py.txt

Category: [[github-code]]

## Summary
from sqlalchemy import Column, Integer, String, Float, DateTime, Boolean, Text, ForeignKey, Index from sqlalchemy.ext.declarative import declarative_base from sqlalchemy.orm import relationship from sqlalchemy.sql import func from datetime import datetime Base = declarative_base() class VideoMetadata(Base): """Video file metadata"""
...
## Metadata
- Source file: junk_drawer/github/DeltaVision/app/db/models.py.txt
