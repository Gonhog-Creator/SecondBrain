...
Source: junk_drawer/Jose Resume - September 2023 (1).pdf
...
December 2021
● Distilled 0.98 moles of liquid bromine from sodium bromide using a variety of acids, reagents,
and reactants. Utilized proper safety procedures and PPE.
WORK EXPERIENCE
Process Engineering Intern, Wolfspeed, Durham, NC
May 2023 – Present
● Utilized statistical process control and experimental design to fine tune machines and eliminate issues in the SiC
wafering process, including software analysis, DOE testing methods, and mechanical trials.
● Worked closely with engineers with various projects with regards to specific processes required in the making of
silicon carbide wafers.
● Currently designing and testing new proprietary systems to enhance yield.
...
SOFTWARE SKILLS: JMP, SPACE, Proprietary Manufacturing Systems, Microsoft Office Tools, JavaScript and JSL
...
## Metadata
- Source file: junk_drawer/Jose Resume - September 2023 (1).pdf
